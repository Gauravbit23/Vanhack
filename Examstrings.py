...
class TestsForStrings(unittest.TestCase):
    ...
    def test2_ForGreater(self):
        strings = ValueComparsions('-1.1', '-1.2')
        self.assertNotEqual(strings.greater(), '-1.2 is greater than -1.1')
    ...
    def test2_ForLesser(self):
        strings = ValueComparsions('-1.1', '-1.2')
        self.assertNotEqual(strings.lesser(), '-1.1 is lesser than -1.2')
    ...
    def test3_ForNotEqual(self):
        strings = ValueComparsions('1.1', '1.2')
        self.assertNotEqual(strings.equal(), '1.1 not equal 1.2')
